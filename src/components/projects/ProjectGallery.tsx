      ...
      <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
        {images.map((img, i) => (
          ...
          >
            ...
            {img.caption && <span className="absolute inset-x-0 bottom-0 bg-black/65 px-3 py-2 text-left text-xs text-white opacity-0 transition-opacity group-hover:opacity-100 focus-within:opacity-100">{img.caption}</span>}
          </motion.button>
        ))}
      </div>
