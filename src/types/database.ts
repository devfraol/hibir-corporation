...
export interface Database {
  public: {
    Tables: {
      ...
      projects: {
        Row: Row<{ id: string; title: string; slug: string; description: string | null; location: string | null; category: string | null; status: ProjectPublicationStatus; project_status: ProjectExecutionStatus | null; client: string | null; consultant: string | null; contract_date: string | null; completion_date: string | null; featured: boolean; cover_image: string | null; seo_title: string | null; seo_description: string | null; created_at: string; updated_at: string }>;
