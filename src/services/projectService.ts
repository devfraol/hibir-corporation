...
/** Public project rendering is Supabase-only after Phase 4.5. */
const getPublishedProjects = async (): Promise<Project[]> => (await fetchPublishedProjectRows()).map(toProject);
